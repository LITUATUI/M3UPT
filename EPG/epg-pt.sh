...
npm run grab --- --site=meo.pt --output=../EPG/epg-meo-pt.xml --days=10 --maxConnections=20
...
npm run grab --- --channels=sites/mi.tv/mi.tv_br.channels.xml --output=../EPG/epg-mitv-br.xml --days=10 --maxConnections=20
