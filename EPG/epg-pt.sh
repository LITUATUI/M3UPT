...
cd ../iptv-org-epg && npm install && npx epg-grabber --config=sites/meo.pt/nos.pt.config.js --channels=../EPG/nos.pt.channels.xml --output=../EPG/epg-nos-pt.xml --days=7 && cd ../EPG && xz -k -f -9 epg-nos-pt.xml && gzip -k -f -9 epg-nos-pt.xml

# RTP EPG

cd ../iptv-org-epg && npm install && npx epg-grabber --config=sites/rtp.pt/nos.pt.config.js --channels=../EPG/rtp.pt.channels.xml --output=../EPG/epg-rtp-pt.xml --days=7 && cd ../EPG && xz -k -f -9 epg-rtp-pt.xml && gzip -k -f -9 epg-rtp-pt.xml
