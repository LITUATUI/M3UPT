...
npm run grab -- --channels=../EPG/meo.pt.channels.xml --output=../EPG/epg-meo-pt.xml --days=7 --maxConnections=5

# Nos EPG

npm run grab -- --channels=../EPG/nostv.pt.channels.xml --output=../EPG/epg-nos-pt.xml --days=7 --maxConnections=5
